    ...
    <div>
      ...
      <div className="flex h-[80%]">
        <div className=" w-1/2 flex flex-col justify-center items-start w-[496px] h-[189px] mt-[116px] ml-[176px] mt-[216px]">
          <h1 className="main  w-[496px] font-[Rye] ">
        ...
        <div className="w-1/2 flex">
          <Image
            ...
            width={490}
            height={667}
            className="w-[442px] h-[611px] mt-[20px] ml-[350px] rounded-tl-[150px] rounded-br-[150px] m-[15px] p-2 border-[5px]  border-[#A29875]  opacity-0px gap-0px"
